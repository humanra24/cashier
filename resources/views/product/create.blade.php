                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        is-invalid
                                    @enderror"
                                        id="stok" name="stok" aria-describedby="stokHelp"
                                        value="{{ old('stok') }}" />
                                    @error('stok')
                                        <div id="stokHelp" class="form-text text-danger">
                                            {{ $message }}
                                        </div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            class="form-control price @error('harga_beli') is-invalid @enderror"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1">Rp</span>
                                        <input type="text"
                                            class="form-control price @error('harga_jual') is-invalid @enderror"
